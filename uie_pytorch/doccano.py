...
if __name__ == "__main__":
    ...
    parser.add_argument("-d", "--doccano_file", default="D:\\python_project\\test\\ai_medical\\data\\intent_classify\\raw\\output_doccano.jsonl",
    ...
    parser.add_argument("--task_type", choices=['ext', 'cls'], default="cls", type=str,
                        help="Select task type, ext for the extraction task and cls for the classification task, defaults to ext.")
    parser.add_argument("--options", default=["request", "consult"], type=str, nargs="+",
                        help="Used only for the classification task, the options for classification")
    parser.add_argument("--prompt_prefix", default="label", type=str,
