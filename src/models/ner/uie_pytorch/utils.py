    ...
    with tqdm(total=len(prompts)) as pbar:
        for i, prompt in enumerate(prompts):
            ...
            if actual_ratio <= negative_ratio or negative_ratio == -1:
                ...
                idxs = random.sample(
                    range(0, len(redundants)), negative_ratio * num_positive
                )
...
def convert_ext_examples(
    ...
    if len(predicate_set) != 0:
        ...
        if is_train:
                ...
                for i, text in enumerate(texts):
                    ...
                    if len(predicate_list[i]) != 0:
                        ...
                        redundants2 = [
                            ...
                            + "的"
                            + predicate_list[i][
                                random.randrange(len(predicate_list[i]))
                            ]
                    ...
                    if len(subject_goldens[i]) != 0:
                        ...
                        redundants3 = [
                            subject_goldens[i][
                                random.randrange(len(subject_goldens[i]))
                            ]
                            + "的"
                            + non_ent_label
            ...
            all_relation_examples = [
                r for relation_example in relation_examples for r in relation_example
            ]
